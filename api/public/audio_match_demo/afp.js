...
let AudioFingerprintRuntime = () => {
  ...
  function getBinary(file) {
    try {
      if (file == Q && w) return new Uint8Array(w)
      ...
      if ('function' != typeof func) {
        ...
        'number' == typeof r
          ? void 0 === func.arg
            ? it(r)()
            : it(r)(func.arg)
          : r(void 0 === func.arg ? null : func.arg)
      } else func(o)
    }
  }
  ...
  function bt(t, e, r) {
    function n(e) {
      ...
      for (var o = 0; o < t.length; ++o) _t(t[o], n[o])
    }
      ...
      i = (t = ct(t)).includes('j')
        ? ((r = t),
          ...
          function () {
            ...
            for (var t = 0; t < arguments.length; t++) o[t] = arguments[t]
            return oe(r, n, o)
          })
        : it(e)
    return (
  ...
  function se(t, e) {
    ...
    throw (
      (e.forEach(function t(e) {
        n[e] || lt[e] || (pt[e] ? pt[e].forEach(t) : (r.push(e), (n[e] = !0)))
      }),
  ...
  function he(t) {
    t > 4 && 0 == --de[t].refcount && ((de[t] = void 0), pe.push(t))
  }
  ...
  function me() {
    for (var t = 5; t < de.length; ++t) if (void 0 !== de[t]) return de[t]
    return null
  }
  var ve = {
    toValue: function (t) {
  ...
  var Te = {
    ...
    printChar: function (t, e) {
      var r = Te.buffers[t]
      0 === e || 10 === e
        ? ((1 === t ? v : g)(UTF8ArrayToString(r, 0)), (r.length = 0))
        : r.push(e)
    },
    varargs: void 0,
    get: function () {
        ...
        _t(t, {
          ...
          toWireType: function (t, e) {
            if ('number' != typeof e && 'boolean' != typeof e)
              throw new TypeError(
                'Cannot convert "' + ge(e) + '" to ' + this.name,
              )
            return e
          },
          argPackAdvance: 8,
        ...
        _t(t, {
          ...
          toWireType: function (t, r) {
            if ('number' != typeof r && 'boolean' != typeof r)
              throw new TypeError(
                'Cannot convert "' + ge(r) + '" to ' + this.name,
              )
            if (r < n || r > o)
              throw new TypeError(
                'Passing a number "' +
        ...
        _t(t, {
          ...
          fromWireType: function (t) {
            ...
            if (r)
              ...
              var s = new Array(n)
              for (i = 0; i < n; ++i) s[i] = String.fromCharCode(O[t + 4 + i])
              e = s.join('')
            }
            return We(t), e
          },
          toWireType: function (t, e) {
            ...
            var o = (
              ...
              i = ke(4 + o + 1)
            if (((R[i >> 2] = o), r && n)) stringToUTF8Array(e, O, i + 4, o + 1)
            else if (n)
              for (var a = 0; a < o; ++a) {
      ...
      i: function (t, e, r, n) {
        for (var o = 0, i = 0; i < r; i++) {
          var a = j[e >> 2],
            u = j[(e + 4) >> 2]
          e += 8
          for (var s = 0; s < u; s++) Te.printChar(t, O[a + s])
          o += u
        }
        return (j[n >> 2] = o), 0
      },
      ...
      ((function () {
          ...
          N.unshift(n),
            (function (t) {
              if (
                ...
                0 == J && (null !== X && (clearInterval(X), (X = null)), Z))
              ) {
                var e = Z
                ;(Z = null), e()
              }
        ...
        function getBinaryPromise(e) {
          return (function () {
            ...
            .then(e, function (t) {
              g('failed to asynchronously prepare wasm: ' + t), abort(t)
            })
        }
        if (
          (J++,
...
export function GenerateFP(PCMBuffer) {
  ...
  */
  ...
  for (let t = 0; t < fp_vector.size(); t++) result_buf[t] = fp_vector.get(t)
